...
def uploadManu():
    ...
    new_df=pd.read_csv('https://markjbs.s3.us-west-2.amazonaws.com/Brand-supplier.csv',encoding='MacRoman',dtype='object')
    new_df_data=new_df.values.tolist()
    brand_new_lower_set = pd.read_csv('https://markjbs.s3.us-west-2.amazonaws.com/Brand-supplier1.csv',encoding='MacRoman',dtype='object').dropna(how='all').reset_index(drop=True).values.tolist()
    ...
    s3.delete_object(
        Bucket='markjbs',
        Key='Brand-supplier1.csv'
    )
    s3.put_object(Bucket="markjbs",
                        Key="Brand-supplier.csv",
                        Body=csv_buffer)
    return 'done'
...
def uploadBrand():
    ...
    brand_new_lower_set = set(pd.read_csv('https://markjbs.s3.us-west-2.amazonaws.com/brands1.csv',encoding='MacRoman',header=None)[0])
    brand_lower_set=brand_lower_set.union(brand_new_lower_set)
...
def uploadDrink():
    ...
    brand_lower_set = set(new_df)
    brand_new_lower_set = set(pd.read_csv('https://markjbs.s3.us-west-2.amazonaws.com/drink_types1.csv',encoding='MacRoman',header=None)[0])
    brand_lower_set=brand_lower_set.union(brand_new_lower_set)
    brand_dataframe=pd.DataFrame(list(brand_lower_set))
    csv_buffer=BytesIO()
    brand_dataframe.to_csv(csv_buffer,index=False)
...
def testingg(column):
    ...
    drink_types_lower = set(pd.read_csv('https://markjbs.s3.us-west-2.amazonaws.com/drink_types.csv',encoding='MacRoman',header=None)[0])
    

    csv_file_path = 'https://markjbs.s3.us-west-2.amazonaws.com/brands.csv'
    brand_name_list=list(pd.read_csv(csv_file_path,encoding='MacRoman',header=None)[0])
    ...
    df=pd.read_csv('https://markjbs.s3.us-west-2.amazonaws.com/input.csv',encoding='MacRoman',dtype='object')
